import { Caravan, TreePine, Zap, Droplets, Wifi, Trash2, Sparkles, type LucideIcon } from "lucide-react";
...
export const ZONE_ICONS: Record<string, { icon: LucideIcon; emoji: string; color: string }> = {
  ...
  "adaptada-9m": { icon: Caravan, emoji: "🚐", color: "text-orange-700 bg-orange-50 ring-orange-200" },
};
